...
def __usage():
    ...
    print " *  usage:                                                                                           *"
    print " *    python behave_all.py [-u] [-only] [-path==directory_path] [-tags==tags_list] [-skip==folders]  *"
    print " *                                                                                                   *"
    print " *  parameters:                                                                                      *"
    ...
    print " *                                                                                                   *"
    print " *  example:                                                                                         *"
    print " *    python behave_all.py -path==components/ngsiv2 -tags==-t=-skip -skip==types,entities -only      *"
    print " *                                                                                                   *"
