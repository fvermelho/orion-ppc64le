...
Feature: verify fields in log traces with update existing entity attributes request using NGSI v2.
  As a context broker user
  I would like to verify fields in log traces with update existing entity attributes request using NGSI v2
  ...
  @traces_in_log
  Scenario:  verify log traces using NGSI v2 with update existing entity attributes request
    ...
    And check in log, label "INFO" and message "Starting transaction from"
      ...
      | comp   | Orion              |
    And check in log, label "DEBUG" and message "--------------------- Serving request PATCH /v2/entities/room_1/attrs -----------------"
      | trace  | value           |
      | time   | ignored         |
      | corr   | N/A             |
      | trans  | N/A             |
