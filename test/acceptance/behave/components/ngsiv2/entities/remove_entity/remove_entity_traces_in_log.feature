...
Feature: verify fields in log traces with remove entity request using NGSI v2.
  As a context broker user
  I would like to verify fields in log traces with remove entity request using NGSI v2
  ...
  @traces_in_log
  Scenario:  verify log traces using NGSI v2 with remove an entity
