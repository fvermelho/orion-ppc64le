...
Feature: create new subscriptions (POST) using NGSI v2. "POST" - /v2/subscriptions plus payload
  ...
  Scenario Outline:  create a new subscription using NGSI v2 with notification http url field values using hostname valids
    ...
    Examples:
      ...
      | https://localhost12345678901234567890123456789012345678901234567890123.localhost12345678901234567890123456789012345678901234567890123.localhost12345678901234567890123456789012345678901234567890123.localhost12345678901234567890123456789012345678901234567890123.1:1456 |
      | http://e34.56.45.34                                                                                                                                                                                                                                                        |
      | http://34.56:3454                                                                                                                                                                                                                                                          |
      | http://a.b--c.de/                                                                                                                                                                                                                                                          |
      | http://0.0.0.0                                                                                                                                                                                                                                                             |
  ...
  Scenario Outline:  try to create a new subscription using NGSI v2 with notification http url field invalid values
    ...
    Examples:
      ...
      | https://localhost12345678901234567890123456789012345678901234567890123.localhost12345678901234567890123456789012345678901234567890123.localhost12345678901234567890123456789012345678901234567890123.localhost12345678901234567890123456789012345678901234567890123.12:1456 |
  ...
  @notification_http_custom_url_invalid @BUG_2280
  Scenario Outline:  try to create a new subscription using NGSI v2 with notification httpCustom url field invalid values
    Given  a definition of headers
      | parameter          | value                            |
      | Fiware-Service     | test_notif_http_custom_url_error |
