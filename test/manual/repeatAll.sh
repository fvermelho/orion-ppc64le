...
repeat.sh 1000 scar ngsi9.subscribeContextAvailabilityRequest.ok.valid.xml
repeat.sh 1000 ucas ngsi9.updateContextAvailabilitySubscriptionRequest.SUBSCRIPTIONID.invalid.xml
repeat.sh 1000 ucar ngsi9.unsubscribeContextAvailabilityRequest.SUBSCRIPTION_ID.invalid.xml
repeat.sh 1000 ncar ngsi9.notifyContextAvailabilityRequest.shortSubscriptionId.invalid.xml
