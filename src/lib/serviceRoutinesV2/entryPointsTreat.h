#ifndef SRC_LIB_SERVICEROUTINESV2_ENTRYPOINTSTREAT_H_
#define SRC_LIB_SERVICEROUTINESV2_ENTRYPOINTSTREAT_H_
...
#endif  // SRC_LIB_SERVICEROUTINESV2_ENTRYPOINTSTREAT_H_
